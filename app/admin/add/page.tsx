    ...
    <div>
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-zinc-500">Create a new property listing.</p>
        </div>
      </div>
        ...
        <div className="p-8">
            {status === "success" && (
                <div className="bg-green-100 border border-green-200 text-green-700 px-4 py-3 rounded-lg mb-6 flex items-center">
                    <span className="font-bold mr-2">Success!</span> Property added. Redirecting...
                </div>
            )}
            
            {status === "error" && (
                <div className="bg-red-100 border border-red-200 text-red-700 px-4 py-3 rounded-lg mb-6 flex items-center">
                    <span className="font-bold mr-2">Error!</span> Failed to add property.
                </div>
            )}
